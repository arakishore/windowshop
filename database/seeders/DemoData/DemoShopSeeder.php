...
class DemoShopSeeder extends Seeder
{
    ...
    private function shops(): array
    {
        return [
            ...
            [
                'merchant_email' => 'sagar@technest.test',
                'category_slug' => 'mobile-electronics',
                'audience_slugs' => ['men', 'women', 'unisex'],
                'name' => 'TechNest Electronics',
                'slug' => 'technest-electronics',
                'short_description' => 'Mobiles, audio gear and useful electronics accessories.',
                'description' => 'A demo electronics storefront for barcode, SKU and warranty-style product workflows.',
                'email' => 'shop@technest.test',
                'mobile' => '9876545678',
                'whatsapp_number' => '9876545678',
                'website_url' => null,
                ...
                'pincode' => '422005',
                'latitude' => '20.0041000',
                'longitude' => '73.7791000',
                'status' => 'active',
                'admin_note' => 'Electronics category demo shop.',
            ],
            [
                'merchant_email' => 'kiran@dailybasket.test',
                'category_slug' => 'grocery-daily-needs',
                'audience_slugs' => ['men', 'women', 'kids', 'unisex'],
                'name' => 'Daily Basket Grocery',
                'slug' => 'daily-basket-grocery',
                'short_description' => 'Daily staples, snacks, beverages and household essentials.',
                'description' => 'A grocery demo shop for fast POS checkout and frequently purchased products.',
                'email' => 'shop@dailybasket.test',
                'mobile' => '9876556789',
                'whatsapp_number' => '9876556789',
                'website_url' => null,
            ...
            [
                ...
                'short_description' => 'Furniture, decor, kitchenware and home essentials.',
                'description' => 'A home and furniture demo storefront for larger-ticket product workflows.',
                'email' => 'shop@homecraft.test',
                'mobile' => '9876578901',
                'whatsapp_number' => '9876578901',
                'website_url' => null,
                ...
                'pincode' => '422011',
                'latitude' => '19.9864000',
                'longitude' => '73.7905000',
                'status' => 'active',
                'admin_note' => 'Home and furniture category demo shop.',
            ],
            [
                'merchant_email' => 'nikhil@fitzone.test',
                'category_slug' => 'sports-fitness',
                'audience_slugs' => ['men', 'women', 'unisex'],
                'name' => 'FitZone Sports',
                'slug' => 'fitzone-sports',
                'short_description' => 'Fitness gear, sportswear and training accessories.',
                'description' => 'A sports and fitness demo shop for equipment and apparel catalogue testing.',
                'email' => 'shop@fitzone.test',
                'mobile' => '9876589012',
                'whatsapp_number' => '9876589012',
                'website_url' => null,
                ...
                'pincode' => '422005',
                'latitude' => '20.0035000',
                'longitude' => '73.7812000',
                'status' => 'active',
                'admin_note' => 'Sports and fitness category demo shop.',
            ],
            [
                'merchant_email' => 'sneha@pageturner.test',
                'category_slug' => 'books-stationery',
                'audience_slugs' => ['kids', 'men', 'women', 'unisex'],
                'name' => 'PageTurner Books',
                'slug' => 'pageturner-books',
                'short_description' => 'Books, notebooks, pens and study essentials.',
                'description' => 'A books and stationery demo shop for school, office and reading products.',
                'email' => 'shop@pageturner.test',
                'mobile' => '9876590123',
                'whatsapp_number' => '9876590123',
                'website_url' => null,
