...
return new class extends Migration
{
    ...
    {
        Schema::create('auth_email_verification_tokens', function (Blueprint $table) {
            $table->id();
            $table->uuid('uuid')
                ->nullable()
                ->unique()
            ...
            $table->string('otp', 255)
                ->nullable()
                ->comment('Hashed OTP if OTP verification is used');
    ...
    {
        Schema::dropIfExists('auth_email_verification_tokens');
    }
};
