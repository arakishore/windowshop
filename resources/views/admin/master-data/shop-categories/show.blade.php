{{-- Purpose: Shows shop category hierarchy, audit details, and direct child categories. --}}
...
@section('breadcrumb')
    <x-page-header
        ...
        :action-url="route('admin.master.shop-categories.edit', $category)"
                    ...
                    <tbody>
                        @foreach($category->children as $child)
                            <tr>
                                ...
                                <td><span class="badge bg-light text-body border">{{ $child->shops_count }}</span></td>
                                <td class="text-center">
                                    <div class="list-icons justify-content-center">
                                        <a href="{{ route('admin.master.shop-categories.show', $child) }}" class="list-icons-item text-info" data-bs-popup="tooltip" title="View">
                                            <i class="ph-eye"></i>
                                        </a>
                                        <a href="{{ route('admin.master.shop-categories.edit', $child) }}" class="list-icons-item text-primary" data-bs-popup="tooltip" title="Edit">
