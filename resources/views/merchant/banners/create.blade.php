...
@section('breadcrumb')
    <x-page-header title="Create Banner" :breadcrumbs="['Merchant' => route('merchant.dashboard'), 'Banners' => route('merchant.banners.index'), 'Create' => null]" />
@endsection
...
@section('content')
    <div class="card">
        ...
        <form method="POST" action="{{ route('merchant.banners.store') }}" enctype="multipart/form-data">
